...
{
    use HasFactory;
    protected $fillable = ['id', 'nomor_surat', 'maksud_perintah', 'transportasi', 'tempat_berangkat', 'tempat_tujuan',  'tgl_pergi', 'tgl_kembali', 'pejabat_pemerintah', 'pejabat_diperintah', 'instansi', 'mata_anggaran', 'keterangan','tgl_keluar' , 'tempat_tujuan_1', 'tgl_tiba_1', 'tgl_berangkat_dari_1', 'tempat_tujuan_2', 'tgl_tiba_2', 'tgl_berangkat_dari_2', 'tempat_tujuan_3', 'tgl_tiba_3', 'tgl_berangkat_dari_3', 'user_id'];
