...
class InstansiAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $pegawai = Pegawai::all();
        return view('admin.pages.instansi', compact('instansi', 'pegawai'))
    ...
    public function create()
    {
        ...
        // dd($instansi);
        return view('admin.pages.instansi.create', ['instansi' => $instansi]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('instansi-admin.index')
    ...
    {
        return view('admin.pages.instansi.show', compact('instansi', 'pegawai'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.instansi.edit', ['instansi' => $instansi, 'pegawai' => $pegawai]);
    }
