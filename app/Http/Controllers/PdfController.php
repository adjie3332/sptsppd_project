...
class PDF_MC_Table extends FPDF
{
    ...
    function TTD($tempat, $tanggal, $bu)
    {
        ...
        $this->MultiCell(0, 5, "KEPALA DINAS KETAHANAN PANGAN KABUPATEN BOYOLALI", 0, 0);
        $this->Ln(20);
        ...
        $this->Cell(76, 5, "", 0, 0);
        $this->Cell(0, 5, "NIP. 9650220 199302 1 002", 0, 1);
    }
...
class PdfController extends Controller
{
    ...
    public function pdf1($id)
    {
        ...
        $this->fpdf->Cell(10, 5, "Demikian Surat Perintah Tugas ini agar dilaksanakan dengan sebaik-baiknya dan penuh tanggung jawab.", 0);
        $this->fpdf->Ln(15);
